...
public class TodoAjaxController {
	...
	/**
	 * @param todoNo : GET 방식 요청은 body가 아닌 주소에 담겨
	 * 전달된 "파라미터" ! -> @ReuqestParam으로 얻어온다.
	 * @return 검색된 제목
	 */
	@ResponseBody // 비동기 요청한 본문 JS 본문으로 값 반환
	 ...
	 */
	@ResponseBody // 호출한 ajax 코드로 값 자제츨 반환(forward X)
	...
	/** 할 일 수정
	 * @param todo : JSON데이터가 변환되어 필드에 값이 대입된 객체
	 * @return result
	 */
	@ResponseBody
