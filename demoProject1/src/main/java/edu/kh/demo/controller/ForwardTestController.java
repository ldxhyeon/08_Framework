...
public class ForwardTestController {
	 ...
	 * 	-> @ReuqestMapping("todo") // todo로 시작하는 요청
	 * 
	 * 2) 메서드 위에 작성하는 경우
	 *	- "요청주소"로 요청을 받은 경우
	 *		 해당 메서드에서 처리 
	...
	// 2) 반환형은 대부분 String
	// (ModelAndView 도는 Ajax 사용 시 달라 질 수 있음)
	...
	@RequestMapping("forward") // forwad 요청 매핑 (GET/POST 가리지 않음)
